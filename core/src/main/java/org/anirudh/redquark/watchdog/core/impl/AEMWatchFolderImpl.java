package org.anirudh.redquark.watchdog.core.impl;
...
import org.anirudh.redquark.watchdog.core.AEMWatchFolder;
...
@Component
@Service
public class AEMWatchFolderImpl implements AEMWatchFolder {

	/**
	 * Default logger
	 */
	private Logger log = LoggerFactory.getLogger(AEMWatchFolder.class);
